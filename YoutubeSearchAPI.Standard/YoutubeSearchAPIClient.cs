// <copyright file="YoutubeSearchAPIClient.cs" company="APIMatic">
...
namespace YoutubeSearchAPI.Standard
{
    ...
    /// </summary>
    public sealed class YoutubeSearchAPIClient : IConfiguration
    {
        ...
        private readonly Lazy<YoutubeSearchController> youtubeSearch;

        private YoutubeSearchAPIClient(
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.youtubeSearch = new Lazy<YoutubeSearchController>(
                () => new YoutubeSearchController(this, this.httpClient, this.authManagers, this.httpCallBack));
        }

        /// <summary>
        /// Gets YoutubeSearchController controller.
        /// </summary>
        public YoutubeSearchController YoutubeSearchController => this.youtubeSearch.Value;
        ...
        /// <summary>
        /// Creates an object of the YoutubeSearchAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> YoutubeSearchAPIClient.</returns>
        internal static YoutubeSearchAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("YOUTUBE_SEARCH_API_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = YoutubeSearchAPI.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>YoutubeSearchAPIClient.</returns>
            public YoutubeSearchAPIClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new YoutubeSearchAPIClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
